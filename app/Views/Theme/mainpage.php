...
<div class="container mt-3 col-sm-8">
    <h4 class="ps-3 text-warning bg-dark mb-0 py-2 rounded-top border border-1 border-light">เลิอกห้อง</h4>
    <div class="container ">
        <div class="row row-cols-auto ">
            <?php foreach ($categorys as $category) : ?>
                <div class="col-sm-1 border border-1 border-light p-3 text-center category">
                    <a href="<?php echo base_url('mainpage_list/' . $category['category']); ?>" class="text-light fw-light" style="text-decoration: none;"><?php echo $category["category"]; ?></a>
                </div>
            <?php endforeach; ?>
        </div>
    </div>
        ...
        <div class=" row-col-1">
            ...
            <?php foreach ($webboards as $webboard) : ?>
                <div class="clearfix visible border border-1 border-light">
                    <a href="<?php echo base_url('mainpage_view/' . $webboard['webboard_id']); ?>" class="float-start text-light fw-light ps-2 pt-2 mt-1 fs-4" style="text-decoration: none;"><b><?php echo $webboard["topic"]; ?></b></a>
